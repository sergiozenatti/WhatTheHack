...
var subnetName = 'sqlmod-${randomString}-subnet'
var virtualNetworkName = 'sqlmod-${randomString}-vnet'
var networkSecurityGroupName = 'sqlmod-${randomString}-nsg'
var publicIpAddressName = 'sqlmod-${randomString}-pub-ip'
var virtualMachineComputerName = 'sqlmod${randomString}com'
var sqlVirtualMachineName = 'sqlmod-${randomString}-sqlvm'

var adminUsername = 'sqladmin${randomString}'
var adminPassword = '${randomString}Aa1!${randomString}'

resource networkInterface_resource 'Microsoft.Network/networkInterfaces@2018-10-01' = {
  name: 'sqlmod-${randomString}-ni'
  location: location
  properties: {
    ipConfigurations: [
      {
...
resource dataDiskResources_name 'Microsoft.Compute/disks@2020-12-01' = {
  name: 'sqlmod-${randomString}_DataDisk'
  location: location
  sku: {
    name: 'Premium_LRS'
  }
